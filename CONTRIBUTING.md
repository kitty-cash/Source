Contributing to KittyCash Core
============================

The KittyCash Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the KittyCash Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/kittycash-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to kittycash-qt
...
The following applies to code changes to the KittyCash Core project (and related
projects such as libsecp256k1), and is not to be confused with overall KittyCash
Network Protocol consensus changes.

Whether a pull request is merged into KittyCash Core rests with the project merge
...
Patches that change KittyCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the KittyCash consensus, it must have been
...
The project leader is the release manager for each KittyCash Core release.
