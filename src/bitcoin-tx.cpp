...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kittycash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kittycash-tx [options] <hex-tx> [commands]  Update hex-encoded kittycash transaction\n" +
            "or:     kittycash-tx [options] -create [commands]   Create hex-encoded kittycash transaction\n" +
            "\n";
