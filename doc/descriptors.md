# Support for Output Descriptors in KittyCash Core

Since KittyCash Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `purr1...` for mainnet or `tpurr1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing KittyCash Core wallets, a convenience function `combo` is
