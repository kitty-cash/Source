...
By default, KittyCash Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that kittycash's trustless model works best if you are
