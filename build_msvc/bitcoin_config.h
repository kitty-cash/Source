...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The KittyCash Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "KittyCash Core"
...
#define PACKAGE_NAME "KittyCash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KittyCash Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kittycash"
