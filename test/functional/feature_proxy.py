...
"""Test kittycashd with different proxy configuration.

Test plan:
- Start kittycashd's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on kittycashd side:
