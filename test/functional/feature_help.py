...
"""Verify that starting kittycash with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kittycash with -h for help text")
        ...
        self.log.info("Start kittycash with -version for version information")
        ...
        self.log.info("Start kittycashd with -fakearg to make sure it does not start")
