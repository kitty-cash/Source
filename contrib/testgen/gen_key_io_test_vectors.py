...
bech32_templates = [
  ...
  ('purr',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('purr',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('purr',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('purr',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tpurr',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpurr',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpurr',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpurr',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tpurr',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpurr',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpurr',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpurr',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rpurr',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rpurr',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rpurr',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rpurr', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tpurr',   17, 32, Encoding.BECH32M, False, False, False),
  ('rpurr',  3,  1, Encoding.BECH32M, False, False, False),
  ('purr',   15, 41, Encoding.BECH32M, False, False, False),
  ('tpurr',    0, 16, Encoding.BECH32,  False, False, False),
  ('rpurr',  0, 32, Encoding.BECH32,  True,  False, False),
  ('purr',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tpurr',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rpurr',  0, 20, Encoding.BECH32,  False, False, True),
  ('purr',    0, 20, Encoding.BECH32M, False, False, False),
  ('tpurr',    0, 32, Encoding.BECH32M, False, False, False),
  ('rpurr',  0, 20, Encoding.BECH32M, False, False, False),
  ('purr',    1, 32, Encoding.BECH32,  False, False, False),
  ('tpurr',    2, 16, Encoding.BECH32,  False, False, False),
  ('rpurr', 16, 20, Encoding.BECH32,  False, False, False),
]
